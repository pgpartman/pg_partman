...
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(11,20), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '1 day'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(21,25), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '2 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(26,30), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '3 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(31,37), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '4 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(40,49), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '1 day'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(50,70), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '2 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(71,85), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '3 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(86,100), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '4 days'::interval));
...
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(101,122), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '5 days'::interval));
...
SELECT run_maintenance();
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(123,150), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '6 days'::interval));
...
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(200,210), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '20 days'::interval));
