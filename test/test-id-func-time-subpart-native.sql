-- ########## SNOWFLAKE PARENT / ID SUBPARENT NATIVE TESTS ##########
-- Additional tests:
...
-- Arbitrary snowflake scheme w/ 20 bit metadata and 43 bit ms timestamp, good until the year 2248
CREATE FUNCTION partman_test.timestamp_to_snowflake(ts TIMESTAMPTZ)
    RETURNS BIGINT LANGUAGE SQL IMMUTABLE PARALLEL SAFE AS
    $$SELECT CAST((EXTRACT(epoch FROM ts))*1000 AS BIGINT) << 20$$;

CREATE FUNCTION partman_test.snowflake_to_timestamp(id bigint)
    RETURNS TIMESTAMPTZ LANGUAGE SQL IMMUTABLE PARALLEL SAFE AS
    $$SELECT TO_TIMESTAMP((id >> 20)/1000.0)$$;
...
SELECT create_parent('partman_test.time_taptest_table'
    ...
    , '1 day'
    , p_epoch := 'func'
    , p_time_encoder := 'partman_test.timestamp_to_snowflake'
    , p_time_decoder := 'partman_test.snowflake_to_timestamp'
    , p_template_table := 'partman_test.template_time_taptest_table'
);
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(1,10), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP));
...
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(11,35), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(1,35), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '1 day'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(1,35), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '2 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(1,35), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '3 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(1,35), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '4 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(1,35), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '1 day'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(1,35), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '2 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(1,35), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '3 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(1,35), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '4 days'::interval));
...
-- insert batch 2
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(36,50), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(36,50), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '1 day'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(36,50), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '2 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(36,50), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '3 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(36,50), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '4 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(1,50), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '5 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(36,50), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '1 day'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(36,50), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '2 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(36,50), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '3 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(36,50), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '4 days'::interval));
...
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(200,210), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(200,210), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '1 day'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(200,210), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '2 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(200,210), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '3 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(200,210), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '4 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(200,210), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP + '5 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(200,210), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '1 day'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(200,210), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '2 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(200,210), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '3 days'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(200,210), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '4 days'::interval));
...
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(211,220), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP - '20 days'::interval));
