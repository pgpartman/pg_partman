...
SELECT has_table('public', 'template_partman_test_time_taptest_table', 'Check that default template table was created');
SELECT table_owner_is ('public', 'template_partman_test_time_taptest_table', 'partman_owner',
