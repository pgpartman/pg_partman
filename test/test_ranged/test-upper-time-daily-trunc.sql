...
CREATE TABLE partman_test.time_taptest_table_1234567890123456789012345678901234567890 (col1 int primary key, col2 text, col3 tstzrange NOT NULL DEFAULT tstzrange(null, CURRENT_TIMESTAMP));
INSERT INTO partman_test.time_taptest_table_1234567890123456789012345678901234567890 (col1, col3) VALUES (generate_series(1,10), tstzrange(null, CURRENT_TIMESTAMP));
...
SELECT create_parent('partman_test.time_taptest_table_1234567890123456789012345678901234567890', 'col3', 'partman', 'daily', p_ranged_boundary := 'upper');
...
INSERT INTO partman_test.time_taptest_table_1234567890123456789012345678901234567890 (col1, col3) VALUES (generate_series(11,20), tstzrange(null, CURRENT_TIMESTAMP + '1 day'::interval));
INSERT INTO partman_test.time_taptest_table_1234567890123456789012345678901234567890 (col1, col3) VALUES (generate_series(21,25), tstzrange(null, CURRENT_TIMESTAMP + '2 days'::interval));
...
INSERT INTO partman_test.time_taptest_table_1234567890123456789012345678901234567890 (col1, col3) VALUES (generate_series(200,210), tstzrange(null, CURRENT_TIMESTAMP + '20 days'::interval));
