...
CREATE TABLE partman_test.time_taptest_table (col1 int primary key, col2 text, col3 tstzrange NOT NULL DEFAULT tstzrange(CURRENT_TIMESTAMP, null)) WITH (OIDS);
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(1,10), tstzrange(CURRENT_TIMESTAMP, null));
...
SELECT create_parent('partman_test.time_taptest_table', 'col3', 'partman', 'daily', p_ranged_boundary := 'lower');
...
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(11,20), tstzrange(CURRENT_TIMESTAMP + '1 day'::interval, null));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(21,25), tstzrange(CURRENT_TIMESTAMP + '2 days'::interval, null));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(26,30), tstzrange(CURRENT_TIMESTAMP + '3 days'::interval, null));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(31,37), tstzrange(CURRENT_TIMESTAMP + '4 days'::interval, null));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(40,49), tstzrange(CURRENT_TIMESTAMP - '1 day'::interval, null));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(50,70), tstzrange(CURRENT_TIMESTAMP - '2 days'::interval, null));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(71,85), tstzrange(CURRENT_TIMESTAMP - '3 days'::interval, null));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(86,100), tstzrange(CURRENT_TIMESTAMP - '4 days'::interval, null));
...
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(101,122), tstzrange(CURRENT_TIMESTAMP + '5 days'::interval, null));
...
SELECT run_maintenance(p_analyze := false);
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(123,150), tstzrange(CURRENT_TIMESTAMP + '6 days'::interval, null));
SELECT run_maintenance(p_analyze := false);
...
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(200,210), tstzrange(CURRENT_TIMESTAMP + '20 days'::interval, null));
