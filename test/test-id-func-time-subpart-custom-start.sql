-- ########## NATIVE ID PARENT / SNOWFLAKE SUBPARENT TESTS ##########
...
CREATE TABLE partman_test.id_taptest_table (
    ...
    , col3 bigint NOT NULL DEFAULT partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP))
...
SELECT create_parent('partman_test.id_taptest_table'
    , 'col1'
    , '10'
    , p_constraint_cols =>'{"col3"}'
    , p_jobmon => false
    , p_template_table => 'partman_test.template_id_taptest_table'
);
...
-- insertion round 2
INSERT INTO partman_test.id_taptest_table (col1, col3) VALUES (generate_series(10,20), partman_test.timestamp_to_snowflake(CURRENT_TIMESTAMP+'1 day'::interval));
