...
CREATE TABLE partman_test.time_taptest_table
    (col1 int
     , col2 text
     , col3 integer DEFAULT partman_test.timestamp_to_julian_day(now()) NOT NULL)
...
SELECT create_parent('partman_test.time_taptest_table'
    ...
    , p_time_encoder =>'partman_test.timestamp_to_julian_day'
    , p_time_decoder => 'partman_test.julian_day_to_timestamp'
    , p_start_partition := date_trunc('month', (CURRENT_TIMESTAMP-'12 months'::interval))::text
);

INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(1,10), partman_test.timestamp_to_julian_day(CURRENT_TIMESTAMP));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(1,10), partman_test.timestamp_to_julian_day(CURRENT_TIMESTAMP-'12 month'::interval));
...
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(11,20), partman_test.timestamp_to_julian_day(CURRENT_TIMESTAMP + '1 month'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(21,25), partman_test.timestamp_to_julian_day(CURRENT_TIMESTAMP + '2 month'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(26,30), partman_test.timestamp_to_julian_day(CURRENT_TIMESTAMP + '3 month'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(31,37), partman_test.timestamp_to_julian_day(CURRENT_TIMESTAMP + '4 month'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(40,49), partman_test.timestamp_to_julian_day(CURRENT_TIMESTAMP - '1 month'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(50,70), partman_test.timestamp_to_julian_day(CURRENT_TIMESTAMP - '2 month'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(71,85), partman_test.timestamp_to_julian_day(CURRENT_TIMESTAMP - '3 month'::interval));
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(86,100), partman_test.timestamp_to_julian_day(CURRENT_TIMESTAMP - '4 month'::interval));
...
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(101,122), partman_test.timestamp_to_julian_day(CURRENT_TIMESTAMP + '5 month'::interval));
...
SELECT run_maintenance();
INSERT INTO partman_test.time_taptest_table (col1, col3) VALUES (generate_series(123,150), partman_test.timestamp_to_julian_day(CURRENT_TIMESTAMP + '6 month'::interval));
