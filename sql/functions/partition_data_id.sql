 ...
 */
CREATE FUNCTION partition_data_id(p_parent_table text, p_batch_count bigint DEFAULT 1, p_batch_interval bigint DEFAULT NULL, p_lock_wait numeric DEFAULT 0, p_order text DEFAULT 'ASC') RETURNS bigint
